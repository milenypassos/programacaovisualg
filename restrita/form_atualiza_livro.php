...
class="form-control">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="autor" id="email-input" name="autor" value= "<?php echo $linha['autor'];?>"  class="form-control">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3">
                                <label for="qtdeExemplares" class=" form-control-label">Qtd de Exemplares</label>
                            </div>
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="qtdeExemplares" value = " <?php echo $linha['qtdeExemplares'];?>" class="form-control">
                            </div>
                        </div>
   <div class="row form-group">
                            <div class="col col-md-3">
                            ...
                            <div class="col-12 col-md-9">
                                <select name="select" id="select" class="form-control">
                                    <option value="Ficção policíal, suspense, mistério e crime"> Ficção policíal, suspense, mistério e crime </option>
                                    <option value="Romance, comédia e aventura"> Romance, comédia e aventura </option>
                                    <option value="Romance e mistério"> Romance e mistério </option>
                                    <option value="Romance"> Romance </option>
                                    <option value="Ficção de aventura e fantasia"> Ficção de aventura e fantasia </option>
                                    <option value="Ação, ficção pos-apocalíptica e fantasia sombria"> Ação, ficção pos-apocalíptica e fantasia sombria </option>
                                    <option value="Ação, ficção supernatural e mistério"> Ação, ficção supernatural e mistério      </option>
                                    <option value="Pintura chinesa, arte e fotografia"> Pintura chinesa, arte e fotografia </option>
                                    <option value="Ficção científica, ação e aventura"> Ficção científica, ação e aventura </option>
                                    <option value="Romance e fantasia"> Romance e fantasia </option>
